...
from model_we.LSTMCNN import LSTMCNN, load_model
from math import exp

Train, Validation, Test = 0, 1, 2

def main(opt):
    project_path = opt.data_dir
    loader = BatchLoaderUnk(opt.tokens, project_path, opt.batch_size, opt.seq_length, opt.max_word_l, opt.n_words, opt.n_chars)
    ...
    if not opt.skip_train:
        ...
        model = LSTMCNN(opt,loader.embedding_matrix)
...
if __name__=="__main__":
    ...
    # data
    parser.add_argument('--data_dir', type=str, default='/chcnn', help='data directory. Should contain train.txt/valid.txt/test.txt with input data')
    # model params
